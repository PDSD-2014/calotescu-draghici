...
import net.cs.chatters.bossychat.database.EmoticonDb;
...
public class ChatActivity extends Activity {
    ...
    public void saveMessageToDB(String sender, String receiver, String message){
       // Message msg = new Message (Utils.username, interlocutor, message, current_nr);
    }
